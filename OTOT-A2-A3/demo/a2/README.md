...
kind load docker-image a1/app --name=kind-1 

path is set to path: /app/(.*), in order to match the path /app/anything (for the static assets like animation.js)
...
app is located at http://localhost/app/